...
export const Winter = () => {
    ...
    return (
        <motion.div
            ...
            style={{
                background: "linear-gradient(to bottom right, #4A90E2, #D6E6F2)", // Frosty Blue Gradient
            }}
        >
            <p className='flex flex-row items-center text-3xl font-light gap-4'>
                <FaRegSnowflake className='w-8 h-8' /> Winter
            </p>
            <p>Lorem ipsum dolor sit amet.</p>
            <p className='text-2xl'> £500 <span className='text-xs'>/mo.</span></p>
            ...
            <motion.button
                ...
                whileTap={{ scale: 0.95 }} className="flex flex-col justify-between items-center bg-blue-500 text-white px-4 py-2 rounded-lg shadow  hover:bg-white hover:text-blue-500 transition-all duration-300" 
                onClick={handleLogin}> 
                <FaPaypal /> <span>Pay with PayPal </span>
            </motion.button>
            <motion.button
                whileHover={{ scale: 1.05, backgroundColor: "#ffffff", color: "#000" }}
                whileTap={{ scale: 0.95 }} className="flex flex-col justify-between items-center bg-gray-800 text-white px-4 py-2 rounded-lg shadow  hover:bg-white hover:text-black transition-all duration-300" 
                onClick={handleLogin}>
