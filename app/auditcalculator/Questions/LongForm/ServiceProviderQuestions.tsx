export const serviceProviderQuestionsSpareCapacity = {
...
export const serviceProviderQuestionsExcessStock = {
    "Fast Food Restaurant": [
      "Maximum seating capacity",
      "Maximum meals per day",
      "Orders through takeout/delivery",
...
export const serviceProviderQuestionsRecommendedSolution = {
    "Fast Food Restaurant": [
      "Maximum seating capacity",
      "Maximum meals per day",
      "Orders through takeout/delivery",
