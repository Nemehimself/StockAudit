...
const Restaurants : React.FC<RestaurantsProps & { selectedGroup: RestaurantGroups }> = ({ selectedGroup }) => {
      ...
      <div className="flex flex-col justify-center w-full px-4 bg-cover bg-center bg-no-repeat  h-full">
        ...
        <div className="flex flex-col gap-4 h-full">
          ...
          <div className="flex flex-row">
            {/* Left Section */}
            <div className="w-2/3 h-[24rem] p-4 mr-2 overflow-y-scroll scrollbar-hidden">
            ...
            <div className="w-1/3 flex flex-col items-center rounded-2xl gap-2 bg-[#fff] p-4">
              ...
              <p className=" text-center text-sm mt-6">Kindly click button below to Watch the Explanation Video</p>
