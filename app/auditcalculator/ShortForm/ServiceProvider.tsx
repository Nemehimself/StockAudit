...
import {serviceProviderQuestionsRecommendedSolution} from "../Questions/LongForm/ServiceProviderQuestions";
...
const ServiceProvider : React.FC<ServiceProviderProps & { selectedGroup: ServiceProviderGroups }> = ({ selectedGroup }) => {
        ...
        <div className="flex flex-col gap-4 h-full">
          ...
          <div className="flex flex-row justify-between w-2/3 h-1/3 bg-[#000] bg-opacity-70 p-4 rounded-3xl">
            ...
            <div className="w-3/4 h-[24rem] p-4 mr-2 overflow-y-scroll scrollbar-hidden">
              ...
              >
                <option value="">Select ServiceProvider Type</option>
