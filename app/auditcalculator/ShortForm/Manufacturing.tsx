...
import {manufacturingQuestionsRecommendedSolution} from "../Questions/LongForm/ManufacturingQuestions";
...
const Manufacturing : React.FC<ManufacturingProps & { selectedGroup: ManufacturingGroups }> = ({ selectedGroup }) => {
  ...
  //   keyof typeof manufacturingExcessStock | ""
  // >("");
