...
import {retailQuestionsRecommendedSolution} from "../Questions/LongForm/RetailQuestions";
...
const Retail : React.FC<RetailProps & { selectedGroup: RetailGroups }> = ({ selectedGroup }) => {
        ...
        {Object.entries(retailExcessStock).map(([key, data]) => (
          ...
          <div className="flex flex-row justify-between w-2/3 h-1/3 bg-[#000] bg-opacity-70 p-4 rounded-3xl">
            ...
            <div className="w-3/4 h-[24rem] p-4 mr-2 overflow-y-scroll scrollbar-hidden">
              ...
              >
                <option value="">Select Retail Type</option>
                {Object.keys(retailQuestionsRecommendedSolution).map(
                  (type) => (
